      ...
      <div className="container-xl">
        <div className="row pb-4">
          ...
          >
            ...
            <p>
              То, что, возможно, не обязательно обо мне знать, но может быть
              интересно: я увлекаюсь фотографией — внизу есть галерея с моими
              любимыми снимками. А ещё интересуюсь психологией людей и собак.
