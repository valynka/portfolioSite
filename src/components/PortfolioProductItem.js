...
const PortfolioProductItem = forwardRef(
...
PortfolioProductItem.displayName = "PortfolioProductItem";

export const MPortfolioProductItem = motion(PortfolioProductItem);
